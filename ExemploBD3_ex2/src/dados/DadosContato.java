...
public class DadosContato {
    ...
    // ATENÇÃO - este método ainda está incompleto
    // recebe um telefone (ou parte dele) e pesquisa os contatos correspondentes
    // Parâmetro telef - o telefone a ser pesquisado
    // retorno: O ResultSet com os dados dos contatos pesquisados
    public static ResultSet obtemContatosPorTelefone(String telef) {
        // ATENÇÃO: - método não implementado, simplesmente retorna null.
        return null;
    }
